...
- Attached: `throw-cert-at-1cf90f63f.js`, the checker as it stands; `THROW-CONTACT-LEMMAS-at-1cf90f63f.md`, the write-up it implements, whose sections 8 to 10 cover the park work, the second arm and the gap; and the scripts behind section 3, `park-monotone.js`, `sustained-contact.js`, `gain-floor.js`, `slab-start.js` and `lapse.js`, with their outputs.
