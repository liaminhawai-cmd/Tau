...
Same conventions as briefs 2 and 3: board units `u`, degrees unless a formula says radians. Everything below was measured today against the engine's own code. Where a number is the checker's rather than the engine's, it says so. The checker's current source and the write-up it implements are attached, both at commit `0bcb6f2b4` and both verified against the repository by blob hash.
...
- Attached: `throw-cert-at-0bcb6f2b4.js`, the enclosure checker as it stands; `THROW-CONTACT-LEMMAS-at-0bcb6f2b4.md`, the write-up it implements, whose sections 8 to 10 cover the park work, the second arm and the gap, section 13 the rigorous H3 bound and the slab result, section 14 the thickness argument of question 1(b) and section 15 the tangential measurement under 1(a); `gain-bound-at-0bcb6f2b4.js`, `slab-shape-at-0bcb6f2b4.js`, `thickness-at-0bcb6f2b4.js` and `tangential-at-0bcb6f2b4.js` with their outputs, the four programs behind those sections; and the scripts behind section 3, `park-monotone.js`, `sustained-contact.js`, `gain-floor.js`, `slab-start.js`, `lapse.js`, `gap-spread.js`, `thickness-spread.js` and `tangential-spread.js`, with their outputs.
