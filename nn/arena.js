...
function main() {
  ...
  // --sweepDeg N: angular resolution of the sweep, default 3. Nearly free (8.5x the stops for 35%
  // more time -- the arc swept is what costs, not the sample count), and finer sampling improves the
