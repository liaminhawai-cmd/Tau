...
// quiet: refresh the summary FILE without printing the whole table. The pass writes it every
// SUMMARY_EVERY_MS as matches land, not only when the window closes -- a window cannot end until
