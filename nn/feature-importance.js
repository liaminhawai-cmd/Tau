...
if (nIn !== 82) console.warn(`warning: this net takes ${nIn} inputs, not 82 -- the names below assume the current feature.js layout and may not line up`);
...
const blocks = { A: [0, 16], B: [16, 46], C: [46, 82] };
