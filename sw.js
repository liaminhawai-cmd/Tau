...
const CACHE = 'tau-v118';  // bump on asset changes so clients drop the old cache (v118: a Low graphics tier and a menu laid out for a touchscreen -- desktop/presentation.js and its stylesheet, both served through this worker on Android)
const ASSETS = [
