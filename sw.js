...
const CACHE = 'tau-v26';  // bump on asset changes so clients drop the old cache (v26: coach board size settles once per transition — text measured before ease, no replay-bar snap)
const ASSETS = [
