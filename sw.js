...
const CACHE = 'tau-v108';  // bump on asset changes so clients drop the old cache (v108: Steam routes like the web at game over, the camera leans a fifth and comes round to a falling piece)
const ASSETS = [
