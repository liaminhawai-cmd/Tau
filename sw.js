...
const CACHE = 'tau-v40';  // bump on asset changes so clients drop the old cache (v40: true prototype piece geometry -- constant tube, vertical ankles, black magnet pins; #lab pivot-drift fix)
const ASSETS = [
