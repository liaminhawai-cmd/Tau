...
const CACHE = 'tau-v24';  // bump on asset changes so clients drop the old cache (v24: coach ease boundaries fixed — one buffer swap per settle, same-size resizes buffer-neutral; terse copy, no handoff modal)
const ASSETS = [
