...
const CACHE = 'tau-v111';  // bump on asset changes so clients drop the old cache (v111: each board is an opponent -- beat them as Blue and as Red to open the next board; the opponent thinks ~5x faster)
const ASSETS = [
