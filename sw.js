...
const CACHE = 'tau-v25';  // bump on asset changes so clients drop the old cache (v25: watching↔playing camera handover crossfades on a smoothstep tween — no more mode-flip lurch)
const ASSETS = [
