...
const CACHE = 'tau-v61';  // bump on asset changes so clients drop the old cache (v61: web quality tiering, crowd, showcase removed, push contact sound, walkthrough reset)
const ASSETS = [
