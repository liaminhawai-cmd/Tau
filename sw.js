...
const CACHE = 'tau-v96';  // bump on asset changes so clients drop the old cache (v96: thin glass walls, the second pass only at a crossing, marble's floor a room below)
const ASSETS = [
