...
const CACHE = 'tau-v41';  // bump on asset changes so clients drop the old cache (v41: #nn merged into #lab -- Human is a per-side brain option, live games vs any lab brain)
const ASSETS = [
