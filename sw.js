...
const CACHE = 'tau-v101';  // bump on asset changes so clients drop the old cache (v101: the membrane grows crystal, the loop is watched from a stand-back, no dust off the marble)
const ASSETS = [
