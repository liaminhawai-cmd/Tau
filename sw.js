...
const CACHE = 'tau-v117';  // bump on asset changes so clients drop the old cache (v117: the ladder now opens on the web game's own generous rule, routes the player up it a rung at a time, and keeps the boards above their reach as silhouettes -- desktop/presentation.js and its stylesheet, both served through this worker on Android)
const ASSETS = [
