...
const CACHE = 'tau-v27';  // bump on asset changes so clients drop the old cache (v27: pale-board foot indicators — white-hot halo ring, ink-ringed pivot pad, white 3D glow)
const ASSETS = [
