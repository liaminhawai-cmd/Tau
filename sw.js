...
const CACHE = 'tau-v110';  // bump on asset changes so clients drop the old cache (v110: the AI thinks a slice at a time instead of freezing the frame, and the camera drifts while it does)
const ASSETS = [
