...
const CACHE = 'tau-v104';  // bump on asset changes so clients drop the old cache (v104: gravity lets go on alien, every octave of the membrane blooms, glass tints at both ends)
const ASSETS = [
