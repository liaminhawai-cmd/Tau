...
const CACHE = 'tau-v111';  // bump on asset changes so clients drop the old cache (v111: the push physics skips contact work whose answer is already known, so the AI thinks about 7x faster with the same moves)
const ASSETS = [
