...
const CACHE = 'tau-v121';  // bump on asset changes so clients drop the old cache (v121: the ladder is thirteen rungs now -- Yellow first, Committee last -- and Committee's own weights are fetched lazily under committee/, never precached here -- index.html, desktop/presentation.js)
const ASSETS = [
