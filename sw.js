...
const CACHE = 'tau-v109';  // bump on asset changes so clients drop the old cache (v109: the stick keeps hold of the camera -- it records the pose it left behind, so the lean no longer undoes every nudge)
const ASSETS = [
