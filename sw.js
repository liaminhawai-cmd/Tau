...
const CACHE = 'tau-v23';  // bump on asset changes so clients drop the old cache (v23: coach resize de-jank — zero buffer reallocs during the ease, ease-in-out curve)
const ASSETS = [
