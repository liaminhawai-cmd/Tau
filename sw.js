...
const CACHE = 'tau-v22';  // bump on asset changes so clients drop the old cache (v22: pale-board ink cues, keep-going nudge, end-pose fix, smooth 3D resize, ladder game-over sheet)
const ASSETS = [
