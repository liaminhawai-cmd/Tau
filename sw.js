...
const CACHE = 'tau-v119';  // bump on asset changes so clients drop the old cache (v119: the graphics tier is now guessed from the device and checked against the frame rate -- desktop/presentation.js, served through this worker on Android)
const ASSETS = [
