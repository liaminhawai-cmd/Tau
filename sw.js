...
const CACHE = 'tau-v120';  // bump on asset changes so clients drop the old cache (v120: a strong desktop/laptop can now be guessed onto High too, not just Balanced -- desktop/presentation.js, served through this worker on Android)
const ASSETS = [
