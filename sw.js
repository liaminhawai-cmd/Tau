...
const CACHE = 'tau-v99';  // bump on asset changes so clients drop the old cache (v99: a depth per board, the alien portal and its tendrils, the camera holds on a break)
const ASSETS = [
