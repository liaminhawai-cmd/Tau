...
const CACHE = 'tau-v116';  // bump on asset changes so clients drop the old cache (v116: board preview icons on the opponent picker and the Colossus arena's crowd and dots -- desktop/presentation.js, its stylesheet and desktop/boards.js, all served through this worker on Android)
const ASSETS = [
