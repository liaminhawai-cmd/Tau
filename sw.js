...
const CACHE = 'tau-v21';  // bump on asset changes so clients drop the old cache (v21: coach slower pacing + pause after resize; free-play reachable-swing rail + narration)
const ASSETS = [
