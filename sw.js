...
const CACHE = 'tau-v35';  // bump on asset changes so clients drop the old cache (v35: fix #nn mode silently forfeiting ~half its turns — signed vs unsigned targetRad)
const ASSETS = [
